...
def parse_arguments():
    parser = argparse.ArgumentParser(prog="InfraBox CLI", description="A command-line interface for managing InfraBox environments. Supports creating and destroying environments with Terraform.")
